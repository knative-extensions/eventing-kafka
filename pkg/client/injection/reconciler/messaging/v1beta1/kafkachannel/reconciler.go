...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1beta1.KafkaChannel, desired *v1beta1.KafkaChannel) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.KafkaChannel, desiredFinalizers sets.String) (*v1beta1.KafkaChannel, error) {
	// Don't modify the informers copy.
