...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1beta1.KafkaBinding, desired *v1beta1.KafkaBinding) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.KafkaBinding, desiredFinalizers sets.Set[string]) (*v1beta1.KafkaBinding, error) {
	// Don't modify the informers copy.
