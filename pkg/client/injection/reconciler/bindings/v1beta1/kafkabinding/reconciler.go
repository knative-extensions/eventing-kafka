...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.KafkaBinding, desiredFinalizers sets.String) (*v1beta1.KafkaBinding, error) {
	// Don't modify the informers copy.
