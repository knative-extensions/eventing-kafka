...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1beta1.KafkaSource, desired *v1beta1.KafkaSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.KafkaSource, desiredFinalizers sets.Set[string]) (*v1beta1.KafkaSource, error) {
	// Don't modify the informers copy.
