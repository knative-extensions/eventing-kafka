...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.KafkaSource, desiredFinalizers sets.String) (*v1beta1.KafkaSource, error) {
	// Don't modify the informers copy.
