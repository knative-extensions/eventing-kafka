...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.ResetOffset, desired *v1alpha1.ResetOffset) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ResetOffset, desiredFinalizers sets.String) (*v1alpha1.ResetOffset, error) {
	// Don't modify the informers copy.
