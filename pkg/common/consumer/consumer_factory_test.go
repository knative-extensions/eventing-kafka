...
func TestErrorPropagationCustomConsumerGroup(t *testing.T) {
	...
	consumerGroup, err := factory.StartConsumerGroup(context.Background(), "bla", []string{}, zap.NewNop().Sugar(), nil)
	if err != nil {
...
func TestErrorWhileCreatingNewConsumerGroup(t *testing.T) {
	...
	_, err := factory.StartConsumerGroup(context.Background(), "bla", []string{}, zap.L().Sugar(), nil)
...
func TestErrorWhileNewConsumerGroup(t *testing.T) {
	...
	cg, _ := factory.StartConsumerGroup(context.Background(), "bla", []string{}, zap.L().Sugar(), nil)
