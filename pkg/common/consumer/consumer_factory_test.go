...
func TestErrorPropagationCustomConsumerGroup(t *testing.T) {
	...
	consumerGroup, err := factory.StartConsumerGroup(NewPassthroughManager(), "bla", []string{}, zap.NewNop().Sugar(), nil)
	if err != nil {
...
func TestErrorWhileCreatingNewConsumerGroup(t *testing.T) {
	...
	_, err := factory.StartConsumerGroup(NewPassthroughManager(), "bla", []string{}, zap.L().Sugar(), nil)
...
func TestErrorWhileNewConsumerGroup(t *testing.T) {
	...
	cg, _ := factory.StartConsumerGroup(NewPassthroughManager(), "bla", []string{}, zap.L().Sugar(), nil)
