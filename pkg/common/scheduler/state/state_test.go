...
func TestStateBuilder(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			replicas:        int32(0),
			vpods:           [][]duckv1alpha1.Placement{},
			expected:        State{Capacity: 10, FreeCap: []int32{}, LastOrdinal: -1, SchedulerPolicy: scheduler.MAXFILLUP, StatefulSetName: sfsName},
			freec:           int32(0),
		...
		},
		{
			...
			expected: State{Capacity: 10, FreeCap: []int32{int32(9)}, LastOrdinal: 0, NumNodes: 1, NumZones: 1, SchedulerPolicy: scheduler.MAXFILLUP, StatefulSetName: sfsName,
		...
		},
		{
			...
			expected: State{Capacity: 10, FreeCap: []int32{int32(8), int32(5), int32(5)}, LastOrdinal: 2, NumNodes: 3, NumZones: 3, SchedulerPolicy: scheduler.MAXFILLUP, StatefulSetName: sfsName,
		...
		},
		{
			...
			expected: State{Capacity: 10, FreeCap: []int32{int32(9), int32(10), int32(5), int32(10)}, LastOrdinal: 2, NumNodes: 4, NumZones: 3, SchedulerPolicy: scheduler.MAXFILLUP, StatefulSetName: sfsName,
		...
		},
		{
			...
			expected: State{Capacity: 10, FreeCap: []int32{int32(3), int32(10), int32(5), int32(10)}, LastOrdinal: 2, NumNodes: 4, NumZones: 3, SchedulerPolicy: scheduler.MAXFILLUP, StatefulSetName: sfsName,
				NodeToZoneMap: map[string]string{"node-0": "zone-0", "node-1": "zone-1", "node-2": "zone-2", "node-3": "zone-0"},
				PodSpread: map[types.NamespacedName]map[string]int32{
					{Name: vpodName + "-0", Namespace: vpodNs + "-0"}: {
		...
		},
		{
			...
			expected: State{Capacity: 10, FreeCap: []int32{int32(4), int32(7), int32(5), int32(10), int32(5)}, LastOrdinal: 4, NumNodes: 4, NumZones: 3, SchedulerPolicy: scheduler.MAXFILLUP, StatefulSetName: sfsName,
				NodeToZoneMap: map[string]string{"node-0": "zone-0", "node-1": "zone-1", "node-2": "zone-2", "node-3": "zone-0"},
				PodSpread: map[types.NamespacedName]map[string]int32{
					{Name: vpodName + "-0", Namespace: vpodNs + "-0"}: {
						"statefulset-name-0": 1,
		...
		},
		{
			...
			expected: State{Capacity: 10, FreeCap: []int32{int32(4), int32(7), int32(5), int32(10), int32(2)}, LastOrdinal: 4, NumNodes: 5, NumZones: 3, SchedulerPolicy: scheduler.MAXFILLUP, StatefulSetName: sfsName,
		...
		},
		{
			...
			vpods: [][]duckv1alpha1.Placement{},
			expected: State{Capacity: 10, FreeCap: []int32{}, LastOrdinal: -1, NumZones: 3, NumNodes: 4, SchedulerPolicy: scheduler.EVENSPREAD, StatefulSetName: sfsName,
				NodeToZoneMap: map[string]string{"node-0": "zone-0", "node-1": "zone-1", "node-2": "zone-2", "node-3": "zone-2"},
			},
			freec:           int32(0),
		...
		},
		{
			...
			vpods: [][]duckv1alpha1.Placement{},
			expected: State{Capacity: 10, FreeCap: []int32{}, LastOrdinal: -1, NumZones: 2, NumNodes: 3, SchedulerPolicy: scheduler.EVENSPREAD, StatefulSetName: sfsName,
				NodeToZoneMap: map[string]string{"node-0": "zone-0", "node-2": "zone-2", "node-3": "zone-2"},
			},
			freec:           int32(0),
			schedulerPolicy: scheduler.EVENSPREAD,
		...
		},
		{
			name:  "no vpods, all nodes with zone labels",
			vpods: [][]duckv1alpha1.Placement{},
			expected: State{Capacity: 10, FreeCap: []int32{}, LastOrdinal: -1, NumZones: 3, NumNodes: 4, SchedulerPolicy: scheduler.EVENSPREAD_BYNODE, StatefulSetName: sfsName,
				NodeToZoneMap: map[string]string{"node-0": "zone-0", "node-1": "zone-1", "node-2": "zone-2", "node-3": "zone-2"},
			},
			freec:           int32(0),
		...
		},
		{
			name:  "no vpods, one node with no label",
			vpods: [][]duckv1alpha1.Placement{},
			expected: State{Capacity: 10, FreeCap: []int32{}, LastOrdinal: -1, NumZones: 2, NumNodes: 3, SchedulerPolicy: scheduler.EVENSPREAD_BYNODE, StatefulSetName: sfsName,
				NodeToZoneMap: map[string]string{"node-0": "zone-0", "node-2": "zone-2", "node-3": "zone-2"},
			},
			freec:           int32(0),
			schedulerPolicy: scheduler.EVENSPREAD_BYNODE,
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			stateBuilder := NewStateBuilder(ctx, sfsName, vpodClient.List, int32(10), tc.schedulerPolicy, lsp.GetPodLister().Pods(testNs), lsn.GetNodeLister())
