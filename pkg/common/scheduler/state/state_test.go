...
func TestStateBuilder(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			vpods: [][]duckv1alpha1.Placement{},
			expected: State{Capacity: 10, FreeCap: []int32{}, LastOrdinal: -1, NumZones: 3, NumNodes: 4, SchedulerPolicy: scheduler.EVENSPREAD, SchedPolicy: &scheduler.SchedulerPolicy{}, DeschedPolicy: &scheduler.SchedulerPolicy{}, StatefulSetName: sfsName,
		...
		},
		{
			...
			vpods: [][]duckv1alpha1.Placement{},
			expected: State{Capacity: 10, FreeCap: []int32{}, LastOrdinal: -1, NumZones: 2, NumNodes: 3, SchedulerPolicy: scheduler.EVENSPREAD, SchedPolicy: &scheduler.SchedulerPolicy{}, DeschedPolicy: &scheduler.SchedulerPolicy{}, StatefulSetName: sfsName,
		...
		},
		{
			name:  "no vpods, all nodes with zone labels",
			vpods: [][]duckv1alpha1.Placement{},
			expected: State{Capacity: 10, FreeCap: []int32{}, LastOrdinal: -1, NumZones: 3, NumNodes: 4, SchedulerPolicy: scheduler.EVENSPREAD_BYNODE, SchedPolicy: &scheduler.SchedulerPolicy{}, DeschedPolicy: &scheduler.SchedulerPolicy{}, StatefulSetName: sfsName,
				NodeToZoneMap: map[string]string{"node-0": "zone-0", "node-1": "zone-1", "node-2": "zone-2", "node-3": "zone-2"},
			},
			freec:           int32(0),
		...
		},
		{
			name:  "no vpods, one node with no label",
			vpods: [][]duckv1alpha1.Placement{},
			expected: State{Capacity: 10, FreeCap: []int32{}, LastOrdinal: -1, NumZones: 2, NumNodes: 3, SchedulerPolicy: scheduler.EVENSPREAD_BYNODE, SchedPolicy: &scheduler.SchedulerPolicy{}, DeschedPolicy: &scheduler.SchedulerPolicy{}, StatefulSetName: sfsName,
				NodeToZoneMap: map[string]string{"node-0": "zone-0", "node-2": "zone-2", "node-3": "zone-2"},
			},
			freec:           int32(0),
			schedulerPolicy: scheduler.EVENSPREAD_BYNODE,
