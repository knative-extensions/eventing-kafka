...
type KafkaChannelUpdater struct {
	logger       *zap.Logger
	clientset    *kafkaclientset.Clientset
	clusterAdmin sarama.ClusterAdmin
}

// NewKafkaChannelUpdater is a convenience constructor of KafkaChannelUpdater structs.
func NewKafkaChannelUpdater(logger *zap.Logger, clientset *kafkaclientset.Clientset, clusterAdmin sarama.ClusterAdmin) *KafkaChannelUpdater {
