...
func main() {
	...
	// Load The Sarama & Eventing-Kafka Configuration From The ConfigMap & Do Some Minimal Validation
	...
	} else if ekConfig == nil || ekConfig.Kafka.Brokers == "" || ekConfig.Sarama.Config == nil {
		logger.Fatal("Loaded Invalid Configuration Settings", zap.Error(err))
	}
