...
readonly KAFKA_CRD_CONFIG_TEMPLATE_DIR="config/channel/consolidated"
...
go_test_e2e -timeout=30m -parallel=20 ./test/e2e -channels=messaging.knative.dev/v1beta1:KafkaChannel  || fail_test
